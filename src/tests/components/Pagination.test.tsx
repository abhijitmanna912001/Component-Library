...
describe("Pagination Component", () => {
  it("should render correctly with given total pages", () => {
    render(
  ...
  it("calls onPageChange when a page number is changed", () => {
  ...
  it("Disables Prev and Next when disabled prop is true", () => {
    render(
      <Pagination
        currentPage={3}
        totalPages={5}
