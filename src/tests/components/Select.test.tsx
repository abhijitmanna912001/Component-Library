...
describe("Select Component", () => {
  ...
  it("applies the correct styles when disabled", () => {
    ...
    const selectedElement = container.firstChild;
    expect(selectedElement).toHaveClass("bg-gray-300");
    expect(selectedElement).toHaveClass("cursor-not-allowed");
    expect(selectedElement).toHaveClass("border-gray-300");
  });
});
